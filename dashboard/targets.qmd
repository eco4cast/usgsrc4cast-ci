...
In addition, five sites in the Sacramento–San Joaquin Delta are contributed by the California Department of Water Resources ([CA DWR](https://water.ca.gov/)).
See [Data sources and quality](#sec-data-sources) below for how those data are assembled and quality-controlled.
...
More information about the sites can be found in the [site metadata](https://radiantearth.github.io/stac-browser/#/external/raw.githubusercontent.com/eco4cast/usgsrc4cast-ci/main/catalog/sites/collection.json) and on USGS's [website](https://dashboard.waterdata.usgs.gov/app/nwd/en/)
