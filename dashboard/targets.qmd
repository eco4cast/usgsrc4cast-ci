...
**What is and isn't quality-controlled:** the historical record for these sites (roughly 2005–2025, depending on station) comes from the QA-QC'd EDI data releases published by CA DWR. The most recent data in the record, or the days more recent than the latest EDI release, comes from CDEC real-time telemetry, which is provisional and not quality-controlled.
